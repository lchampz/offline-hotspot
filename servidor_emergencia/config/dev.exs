...
config :servidor_emergencia, ServidorEmergencia.Repo,
  database: Path.expand("../servidor_emergencia_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :servidor_emergencia, ServidorEmergenciaWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:servidor_emergencia, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:servidor_emergencia, ~w(--watch)]}
  ]
