...
config :emergency_server, EmergencyServer.Repo,
  database: Path.expand("../emergency_server_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :emergency_server, EmergencyServerWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:emergency_server, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:emergency_server, ~w(--watch)]}
  ]
